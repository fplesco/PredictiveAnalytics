...
put 'DROP="N";';
put 'end;';
put 'if NAME="itemDescription" then do;';
put 'ROLE="TARGET";';
put 'LEVEL="NOMINAL";';
put 'ORDER="";';
put 'DROP="N";';
put 'end;';
put 'if NAME="Member_number" then do;';
put 'ROLE="ID";';
put 'LEVEL="INTERVAL";';
put 'ORDER="";';
put 'DROP="N";';
...
id= "FIMPORT";
property="IFileName";
value= "C:\Users\fples\Documents\GitHub\PredictiveAnalytics\ARM\Groceries_dataset.csv";
output;
id= "FIMPORT";
